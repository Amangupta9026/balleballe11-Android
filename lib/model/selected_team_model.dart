...
//
//     final selectedTeamModel = selectedTeamModelFromJson(jsonString);

import 'dart:convert';

SelectedTeamModel selectedTeamModelFromJson(String str) => SelectedTeamModel.fromJson(json.decode(str));

String selectedTeamModelToJson(SelectedTeamModel data) => json.encode(data.toJson());

class SelectedTeamModel {
  SelectedTeamModel({
    this.systemTime,
    this.matchStatus,
    this.matchTime,
  ...
  factory SelectedTeamModel.fromJson(Map<String, dynamic> json) => SelectedTeamModel(
...
class Response {
  ...
  factory Response.fromJson(Map<String, dynamic> json) => Response(
    myteam: List<Myteam>.from(json["myteam"].map((x) => Myteam.fromJson(x))),
  );
