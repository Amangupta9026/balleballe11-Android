...
class GetMyTeamDetailList extends StatefulWidget {
  int teamId;
  ...
  @override
  GetMyTeamDetailListState createState() => GetMyTeamDetailListState();
}

class GetMyTeamDetailListState extends State<GetMyTeamDetailList> {
