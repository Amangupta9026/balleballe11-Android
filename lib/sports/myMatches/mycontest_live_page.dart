...
import 'package:balleballe11/sports/join_contest/select_team_join_contest.dart';
...
class MyContestLivePage extends StatefulWidget {
  ...
  @override
  _MyContestLivePageState createState() => _MyContestLivePageState();
}

class _MyContestLivePageState extends State<MyContestLivePage> {
                        ...
                        child: Flex(
                          ...
                          children: [
                                  ...
                                  onTap: () async {
                                    JoinNewContestStatusModel joinResp =
                                        await APIServices.joinNewContestStatus(
                                            widget.contestDetails.contestId,
                            ...
                            Flex(
                              ...
                              children: [
                                Visibility(
                                  visible: widget.contestDetails.filledSpots !=
                                          null &&
                                      widget.contestDetails.filledSpots > 0,
                                    ...
                                    text: TextSpan(
                                      children: [
                                        if (widget.contestDetails.totalSpots ==
                                          ...
                                          TextSpan(
                                            text:
                                                "${((widget.contestDetails.totalSpots) - widget.contestDetails.filledSpots)} Spots Left",
                                            style: TextStyle(
                                                fontSize: 12.0,
                                                color: Color(0xffec9f83),
                                                fontWeight: FontWeight.w800),
                ...
                child: Column(
                  children: [
                    InkWell(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.only(
                            top: 7.0, bottom: 7, left: 8, right: 12),
                        child: Row(
                          children: [
                            Expanded(
                              flex: 6,
