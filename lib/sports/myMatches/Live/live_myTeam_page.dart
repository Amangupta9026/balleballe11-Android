...
class LiveMyTeamPage extends StatefulWidget {
  Live selectedMatchData;
  bool isFromView;
  String pageFromMatch = "";
  LiveMyTeamPage(Live selectedMatchData,
  ...
  @override
  _LiveMyTeamPageState createState() => _LiveMyTeamPageState();
}

class _LiveMyTeamPageState extends State<LiveMyTeamPage> {
