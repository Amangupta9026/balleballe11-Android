...
import 'live_match_teampreview_nocontest.dart';

class LiveNoContestTeamPage extends StatefulWidget {
  ...
  @override
  _LiveNoContestTeamPageState createState() => _LiveNoContestTeamPageState();
}

class _LiveNoContestTeamPageState extends State<LiveNoContestTeamPage> {
    ...
    return InkWell(
      onTap: () async {
        ...
        Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => LiveMatchTeamPreviewNoContest(
