...
import 'dashboard_lice_match_contest_page.dart';


class DashboardLiveMatchDetailPage extends StatefulWidget {
  ...
  @override
  _DashboardLiveMatchDetailPageState createState() => _DashboardLiveMatchDetailPageState();
}

class _DashboardLiveMatchDetailPageState extends State<DashboardLiveMatchDetailPage> {
        ...
        onTap: () async {
          ...
          if (!getMyContestList[contestindex].isCancelled)
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => DashboardLiveMatchContestPage(
