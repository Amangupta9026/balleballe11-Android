...
class DashboardLiveMatchMyTeamDetail extends StatefulWidget {
  int teamId;
...
//  String teamName;
  ...
  DashboardLiveMatchMyTeamDetail({
    key: Key,
    this.teamId,
    this.teamName,
  ...
  @override
  DashboardLiveMatchMyTeamDetailState createState() => DashboardLiveMatchMyTeamDetailState();
}

class DashboardLiveMatchMyTeamDetailState extends State<DashboardLiveMatchMyTeamDetail> {
