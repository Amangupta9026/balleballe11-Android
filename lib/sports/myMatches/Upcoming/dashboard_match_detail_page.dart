...
import 'dashboard_completed_matchContestPage.dart';

class DashboardMatchDetailPage extends StatefulWidget {
  ...
  @override
  _DashboardMatchDetailPageState createState() =>
      _DashboardMatchDetailPageState();
}

class _DashboardMatchDetailPageState extends State<DashboardMatchDetailPage> {
        ...
        onTap: () async {
         ...
         if (!getMyContestList[contestindex].isCancelled)
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => DashboardCompletedMatchContestPage(
