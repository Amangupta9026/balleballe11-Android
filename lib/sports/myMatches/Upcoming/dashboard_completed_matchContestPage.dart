...
class DashboardCompletedMatchContestPage extends StatefulWidget {
  ...
  DashboardCompletedMatchContestPage(
      {Key key,
  ...
  @override
  _DashboardCompletedMatchContestPageState createState() =>
      _DashboardCompletedMatchContestPageState();
}

class _DashboardCompletedMatchContestPageState
    extends State<DashboardCompletedMatchContestPage> {
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Text(
                            "${widget.selectedMatchData.statusStr?.toUpperCase()}",
                            style:
                    ...
                    InkWell(
                      onTap: () async {
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  DashboardCompletedMatchMyTeamDetail(
                            ...
                            Expanded(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  //         width: 1.5),
                                  //     image: DecorationImage(
                                  //       image: myLeaderBoardList[index]
                                  //                       .user
                                  //                       .profileImage !=
                                  //                   null &&
                                  //               myLeaderBoardList[index]
                                  //                   .user
                                  //                   .profileImage
                                  //                   .isNotEmpty
                                  //           ? NetworkImage(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      for (int i = 1;
                                          i <=
                                              widget.contestDetails.winnerCount;
                                          i++)
                                        if (i == myLeaderBoardList[index].rank)
                                          Visibility(
                                            visible:
