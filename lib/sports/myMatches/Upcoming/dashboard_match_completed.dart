...
import 'dashboard_completed_myteam_page.dart';
import 'dashboard_match_detail_page.dart';


class DashboardMatchContestCompleted extends StatefulWidget {
  String pageFromMatch = "";
//  Completed selectedMatchData;
  Joinedmatch joinedmatches;
  String teama;
  String teamb;
  String status;
//  int matchId;
  ...
  DashboardMatchContestCompleted({
    this.joinedmatches,
    this.pageFromMatch,
    this.teama,
    this.teamb,
    ...
    this.joinedmatches = joinedmatches;
    // this.selectedData = selectedData;
  }

  @override
  _DashboardMatchContestCompletedState createState() =>
      _DashboardMatchContestCompletedState();
}

class _DashboardMatchContestCompletedState
    extends State<DashboardMatchContestCompleted>
  ...
  Future<void> getMyContest() async {
    try {
      ...
      myContestModel =
          await APIServices.getMyContestData(widget.joinedmatches?.matchId);
    ...
    return AppBar(
      ...
      title: Row(
        ...
        children: [
          ...
          Spacer(),
          Text(
            "${widget?.joinedmatches?.statusStr?.toUpperCase() ?? widget.status.toUpperCase()}",
            style: Theme.of(context).textTheme.caption.copyWith(
