...
class CompletedMyTeamPage extends StatefulWidget {
  ...
  @override
  _CompletedMyTeamPageState createState() => _CompletedMyTeamPageState();
}

class _CompletedMyTeamPageState extends State<CompletedMyTeamPage> {
  String pageFromMatch = "";
