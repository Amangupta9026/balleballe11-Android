...
class CompletedMatchMyTeamDetail extends StatefulWidget {
  int teamId;
...
//  String teamName;
  ...
  @override
  CompletedMatchMyTeamDetailState createState() =>
      CompletedMatchMyTeamDetailState();
}

class CompletedMatchMyTeamDetailState
    extends State<CompletedMatchMyTeamDetail> {
