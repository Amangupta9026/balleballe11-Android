...
import 'completed_match_myteam_details.dart';

class CompletedMatchContestPage extends StatefulWidget {
  ...
  @override
  _CompletedMatchContestPageState createState() =>
      _CompletedMatchContestPageState();
}

class _CompletedMatchContestPageState extends State<CompletedMatchContestPage> {
                    ...
                    InkWell(
                      onTap: () async {
                        ...
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => CompletedMatchMyTeamDetail(
